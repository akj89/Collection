...
public class ListExample {
	...
	public static void main(String[] args) {
		...
		first5PrimeNums.stream().forEach( num -> { System.out.println(num); });
		
		// Sort and reverse
		Collections.sort(first5PrimeNums);
		System.out.println(first5PrimeNums);
		
		Collections.reverse(first5PrimeNums);
		System.out.println(first5PrimeNums);
